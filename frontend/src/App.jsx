    ...
    <div className="font-sans text-gray-800 bg-gray-50 min-h-screen">
      ...
      <nav className="bg-white/90 backdrop-blur-md sticky top-0 z-50 shadow-sm border-b border-pink-100">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 font-medium text-gray-600">
            ...
            <Link to="/san-pham" className="hover:text-pink-600 transition">
              Sản phẩm
            </Link>
            <Link to="/lien-he" className="hover:text-pink-600 transition">
              Liên hệ
            </Link>
          </div>
                  ...
                  {currentUser ? (
                    <>
                      ...
                      {/* {currentUser.role === "admin" && (
                        <Link
                          to="/admin"
                          className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition"
                        >
      ...
      <Routes>
        ...
        <Route
          path="*"
          element={
            <div className="text-center py-20">404 - Không tìm thấy trang</div>
          }
        />
      </Routes>
    </div>
